...
public class Ejercicio12 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (cadena.substring(0, 1).equals("x") && cadena.substring(longitud - 1, longitud).equals("o") && longitud <= 5) {
        ...
        System.out.println("Se encontro una frase FDE y termino el programa");
